<?php
	...
	$dataSet->addPoint(new Point("Grade A ($A)",$A));
	$dataSet->addPoint(new Point("Grade B ($B)", $B));
	$dataSet->addPoint(new Point("Grade C ($C)", $C));
	$dataSet->addPoint(new Point("Grade D ($D)", $D));
	$dataSet->addPoint(new Point("Grade F ($F)", $F));
	$chart->setDataSet($dataSet);

	$chart->setTitle("Powered By www.basis.org.bd");
