...
<div id="invoice" class="new">
	...
	<section id="parties">
		...
		<div class="invoice-to">
			...
			<div id="hcard-Hiram-Roth" class="vcard">
			  ...
			  <a class="email" href="mailto:<?php echo $billing_info->email_address;?>"><?php echo $billing_info->email_address;?></a>
				
				<div class="adr">
				  <div class="street-address"></div>
			  </div>

				<div class="tel">+88-<?php echo $billing_info->mobile_no;?></div>
			</div><!-- e: vcard -->
		</div><!-- e invoice-to -->
		...
		<div class="invoice-from">
			...
			<div id="hcard-Admiral-Valdore" class="vcard">
				<span><?php echo $shipping_info->full_name?></span>
				<div class="org"><?php echo $shipping_info->address;?><span class="street-address">-<?php echo $billing_info->zip_code;?></span></div>
                                <div class="org">
                                    <script type="text/javascript">
                                        var key='<?php echo $shipping_info->country;?>';
                                        document.write(getCountryFullName(key));
                                    </script>
                                </div>
			  <a class="email" href="mailto:<?php echo $shipping_info->email_address;?>"><?php echo $shipping_info->email_address;?></a>
				
				<div class="adr">
				  <div class="street-address"></div>
			  </div>

				<div class="tel">+88-<?php echo $shipping_info->mobile_no;?></div>
			</div><!-- e: vcard -->
		</div><!-- e invoice-from -->
	...
	<section class="invoice-financials">
			...
			<table>
				...
				<tbody>
					<?php
						...
						<td>BDT <?php echo $v_order_details->product_price;?></td>
                                                <td>BDT <?php echo $v_order_details->product_price * $v_order_details->product_sales_quantity;?></td>
					</tr>
                                            <?php } ?>
	  ...
	  <div class="invoice-totals">
		...
		<div class="invoice-notes">
			Please be Noted after delivery product within fifteen days you can return product or refund. product return is only applicable for electronic product.
		</div><!-- e: invoice-notes -->
	...
	<footer id="footer">
		<p>
		Contact: www.abc.com Phone: 008803455656 Email: info@beizerautomobiles.com 
		</p>
	</footer>
