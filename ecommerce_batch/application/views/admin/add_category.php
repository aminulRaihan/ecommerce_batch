    ...
    <div class="col-md-12">                        
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <form role="form"  action="<?php echo base_url() ?>super_admin/save_category" method="post"  class="form-horizontal form-groups-bordered" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <textarea class="form-control autogrow"  name="category_description" placeholder="Category Description"></textarea>
                        </div>
                    </div>
