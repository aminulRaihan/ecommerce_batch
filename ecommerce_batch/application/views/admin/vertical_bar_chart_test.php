<?php
	...
	$dataSet->addPoint(new Point("Jan 2005", 12273));
	...
	$chart->render("report/barchart.png");
?>
...
<body>
	<img alt="Vertical bars chart" src="<?php echo base_url();?>report/barchart.png" style="border: 1px solid gray;"/>
</body>
</html>
